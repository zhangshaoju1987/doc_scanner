...
import { useAnimatedPagerScrollHandler, useAnimatedPagerScrollStateHandler, useAnimatedPagerSelectedPageHandler, } from './useAnimatedPagerHandler';
...
export function PagerExample() {
    ...
    return (<View style={styles.container}>
      ...
      <AnimatedPagerView initialPage={0} onPageScroll={scrollHandler} onPageScrollStateChanged={scrollStateHandler} onPageSelected={selectedPageHandler} orientation="horizontal" style={styles.pager}>
        {SLIDES.map((slide) => (<View key={slide.key} collapsable={false} style={[styles.slide, { backgroundColor: slide.color }]}>
