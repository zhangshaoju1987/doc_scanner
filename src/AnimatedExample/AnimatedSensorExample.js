...
import Animated, { withTiming, useAnimatedStyle, useAnimatedSensor, SensorType, } from 'react-native-reanimated';
...
export default function AnimatedStyleUpdateExample() {
    ...
    return (<View style={componentStyle.container}>
      <Button title={'log data'} onPress={() => console.log(animatedSensor.sensor.value)}/>
