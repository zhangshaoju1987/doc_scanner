...
import Animated, { useSharedValue, useAnimatedStyle, runOnUI, useAnimatedGestureHandler, interpolate, Extrapolate, withTiming, Easing, } from 'react-native-reanimated';
...
function ListItem({ item, index, onPress }) {
    ...
    return (<TouchableWithoutFeedback style={containerStyle} onPress={() => onPress(ref, item, opacity)}>
...
function LightboxExample() {
    ...
    function onItemPress(imageRef, item, sv) {
        var _a, _b;
        (_b = (_a = imageRef.current) === null || _a === void 0 ? void 0 : _a.measure) === null || _b === void 0 ? void 0 : _b.call(_a, (_x, _y, width, height, pageX, pageY) => {
            if (width === 0 && height === 0) {
                return;
            }
