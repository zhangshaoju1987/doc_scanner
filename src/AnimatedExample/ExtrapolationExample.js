...
import Animated, { useAnimatedGestureHandler, useAnimatedStyle, useSharedValue, interpolate, withTiming, Extrapolate, } from 'react-native-reanimated';
...
function ExtrapolationExample() {
    ...
    const button1Style = useAnimatedStyle(() => {
        const translateX = Math.round(interpolate(translation.y.value, [0, -75], [0, -75], {
    ...
    const button2Style = useAnimatedStyle(() => {
        const translateY = Math.round(interpolate(translation.y.value, [0, -75], [0, -150], {
            extrapolateLeft: Extrapolate.CLAMP,
            extrapolateRight: Extrapolate.EXTEND,
        }));
        return {
