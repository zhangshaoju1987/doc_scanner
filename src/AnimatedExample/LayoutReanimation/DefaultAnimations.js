...
import Animated, { SlideInRight, SlideOutRight, SlideInUp, SlideInDown, SlideOutUp, SlideOutDown, FadeIn, FadeInRight, FadeInLeft, FadeInUp, FadeInDown, FadeOut, FadeOutRight, FadeOutLeft, FadeOutUp, FadeOutDown, SlideOutLeft, SlideInLeft, ZoomIn, ZoomInRotate, ZoomInRight, ZoomInLeft, ZoomInUp, ZoomInDown, ZoomInEasyUp, ZoomInEasyDown, ZoomOut, ZoomOutRotate, ZoomOutRight, ZoomOutLeft, ZoomOutUp, ZoomOutDown, ZoomOutEasyUp, ZoomOutEasyDown, StretchInX, StretchInY, StretchOutX, StretchOutY, FlipInXUp, FlipInYLeft, FlipInXDown, FlipInYRight, FlipInEasyX, FlipInEasyY, FlipOutXUp, FlipOutYLeft, FlipOutXDown, FlipOutYRight, FlipOutEasyX, FlipOutEasyY, BounceIn, BounceInDown, BounceInUp, BounceInLeft, BounceInRight, BounceOut, BounceOutDown, BounceOutUp, BounceOutLeft, BounceOutRight, LightSpeedInRight, LightSpeedInLeft, LightSpeedOutRight, LightSpeedOutLeft, PinwheelIn, PinwheelOut, RotateInDownLeft, RotateInDownRight, RotateInUpLeft, RotateInUpRight, RotateOutDownLeft, RotateOutDownRight, RotateOutUpLeft, RotateOutUpRight, RollInLeft, RollInRight, RollOutLeft, RollOutRight, } from 'react-native-reanimated';
const AnimatedBlock = ({ name, animatedStyle, defaultShow, }) => {
    const [show, setShow] = useState(defaultShow);
    return (<View style={styles.animatedBox}>
      {show ? (<TouchableWithoutFeedback onPress={() => setShow(!show)}>
          <Animated.View style={styles.animatedBlock} {...animatedStyle}>
            <Text style={styles.animatedText}>{name}</Text>
          </Animated.View>
        </TouchableWithoutFeedback>) : null}
      {!show ? (<Animated.View entering={'entering' in animatedStyle ? undefined : FadeIn.delay(350)}>
...
export function DefaultAnimations() {
    return (<ScrollView style={{ flexDirection: 'column' }}>
      ...
      <AnimatedBlock name="FadeOutRight" animatedStyle={{
        exiting: FadeOutRight.withCallback((_finished) => {
            'worklet';
