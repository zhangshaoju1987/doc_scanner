...
function SWMLogo() {
    return (<View>
      <Animated.View entering={SlideInRight.delay(300)} exiting={SlideOutLeft.delay(300)} style={styles.left}/>
      <Animated.View entering={SlideInDown} exiting={SlideOutUp} style={styles.top}/>
      <Animated.View entering={SlideInLeft} exiting={SlideOutRight} style={styles.animatedView}>
        <AnimatedText entering={FadeIn.delay(600).duration(3000)} exiting={FadeOut.duration(3000)}>
          SWM
        </AnimatedText>
      </Animated.View>
    </View>);
}
export function MountingUnmounting() {
