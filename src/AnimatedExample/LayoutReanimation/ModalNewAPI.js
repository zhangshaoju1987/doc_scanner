...
import Animated, { withTiming, withDelay, Layout, } from 'react-native-reanimated';
...
function AnimatedView() {
    ...
    return (<Animated.View ref={ref} style={[styles.animatedView]} {...{ entering, exiting, layout: Layout }}>
      <Text> kk </Text>
    </Animated.View>);
}
export function ModalNewAPI() {
