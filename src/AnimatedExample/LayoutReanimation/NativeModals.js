...
const App = ({ navigation, }) => {
    ...
    return (<View style={styles.centeredView}>
      ...
      <Pressable style={[styles.button, styles.buttonOpen]} onPress={() => navigation.navigate('Modal')}>
        <Text style={styles.textStyle}>Go to next Screen</Text>
      </Pressable>
      <Pressable style={[styles.button, styles.buttonOpen]} onPress={() => navigation.goBack()}>
